...
/// Alternate code is needed for a coupled DHX
///
pub fn new_mesh_refined_isolated_dhx_tube_side_30_parallel_tubes(
...
/// has the same loss correlations as the CTAH (horizontal)
///
pub fn new_mesh_refined_ndhx_tchx_vertical_35b_1(initial_temperature: ThermodynamicTemperature) -> 
NonInsulatedFluidComponent {
    let ambient_temperature = ThermodynamicTemperature::new::<degree_celsius>(20.0);
    let fluid_pressure = Pressure::new::<atmosphere>(1.0);
    let solid_pressure = Pressure::new::<atmosphere>(1.0);
...
/// has the same loss correlations as the CTAH (horizontal)
///
pub fn new_mesh_refined_ndhx_tchx_vertical_35b_2(initial_temperature: ThermodynamicTemperature) -> 
NonInsulatedFluidComponent {
    let ambient_temperature = ThermodynamicTemperature::new::<degree_celsius>(20.0);
    let fluid_pressure = Pressure::new::<atmosphere>(1.0);
    let solid_pressure = Pressure::new::<atmosphere>(1.0);
